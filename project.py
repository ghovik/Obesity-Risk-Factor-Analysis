...
brfss = pd.concat([race, age, sex, height, weight, bmi, smoke_status, general_health, sleep_hour, has_heart_disease, has_cancer, 
                  mental_health, binge_drinker, has_diabetes], axis=1)
brfss.columns = ['race', 'age', 'sex', 'height', 'weight', 'bmi', 'smoke_status', 'general_health', 'sleep_hour', 'has_heart_disease', 
